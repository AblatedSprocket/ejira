...
(defcustom ejira-org-todo-keywords-alist nil
  "List of Org todo keywords to be inserted into Ejira org file so org-todo-keywords does not need to be set globally."
  :group 'ejira
  :tag "JIRA state map"
        ...
        (unless exists-p
          (if (assoc key ejira-org-todo-keywords-alist)
              (let ((todos ""))
                ...
                (write-region (format "#+STARTUP: showevertyhing\n#+TODO:%s\n" todos) nil project-file-name))
